...
external volatility (Chow, 2017). Research focused on ASEAN also finds
significant volatility transmission from the United States (Vo and Tran,
2020), while evidence for Vietnam indicates meaningful linkages with
advanced markets (Vo and Ellis, 2018). Recent studies have moved closer
to the present setting. Sethapramote et al. (2023) examine dynamic
connectedness between ASEAN and global equity markets during COVID-19,
while Al Anshari (2025) studies the evolution of an ASEAN-6 network,
...
uncertainty (Hoque et al., 2026). Consequently, the remaining gap is not
the absence of ASEAN network evidence. Rather, three issues remain
...
emphasized by Forbes and Rigobon (2002), contagion requires an increase
in cross-market linkages following a shock; otherwise, the evidence may
...
(Diebold and Yilmaz, 2012; Pesaran and Shin, 1998). Rolling-window
estimation then reveals changes in regional connectedness and in each
market's systemic role over time.
...
emphasis of Sethapramote et al. (2023) and the correlation- and
graph-based network analysis of Al Anshari (2025).
...
In contrast, Forbes and Rigobon (2002) define contagion in terms of a
...
The connectedness approach of Diebold and Yilmaz (2012) is well suited
to this question because it separates shocks transmitted *to* a market
from those transmitted *from* it. Its network interpretation also
permits each market to be represented as a node joined by weighted,
directed edges (Diebold and Yilmaz, 2014).

Two recent ASEAN studies provide especially close benchmarks.
Sethapramote et al. (2023) report that spillovers from global equity
markets to ASEAN increased during COVID-19 and that the contribution of
intraregional ASEAN spillovers also became more important. Using all six
markets examined here, Al Anshari (2025) documents crisis-related
changes in ASEAN-6 correlation and network structure between 2011 and
2024. The present study differs by modeling volatility rather than
return-network similarity, deriving directional shares from generalized
forecast-error variance decompositions, examining several distinct
global episodes, and formally testing shock-window differences.
...
shocks (Chow, 2017; Vo and Tran, 2020). These effects may be nonlinear:
...
baseline volatility proxy is the range-based estimator of Parkinson
(1980): $$\begin{equation}
...
index is from Caldara and Iacoviello (2022). VIX and GPR enter as
monthly averages. Oil, dollar, and S&P 500 variables are end-of-month
log changes in percent, while the Treasury yield is an end-of-month
...
from mid-2011 (European Central Bank, 2012); Ben Bernanke's May 22, 2013
congressional testimony, which initiated the taper-tantrum repricing
(Bernanke, 2013); the mid-2015 plunge in Chinese equities (Bank for
International Settlements, 2015); the March 22, 2018 announcement of US
trade action against China (Office of the United States Trade
Representative, 2018); the World Health Organization's January 30, 2020
declaration of a Public Health Emergency of International Concern (World
Health Organization, 2020); Russia's February 24, 2022 invasion of
Ukraine (United Nations General Assembly, 2022); the Federal Reserve's
sequence of 75-basis-point rate increases beginning in June 2022 (Board
of Governors of the Federal Reserve System, 2023a); and the March 10,
2023 closure of Silicon Valley Bank (Board of Governors of the Federal
Reserve System, 2023b). End dates were set to capture the initial or
sustained market-adjustment phase while preventing overlap between the
two 2022 episodes.
...
Following Pesaran and Shin (1998) and Diebold and Yilmaz (2012), the
generalized $H$-step-ahead forecast-error variance contribution of
shocks in market $j$ to the forecast-error variance of market $i$ is
$$\begin{equation}
 \theta_{ij}^{g}(H)=
...
lengths of 10 and 20 trading days (Künsch, 1989). A positive difference
...
rolling windows (Newey and West, 1987). The coefficients are interpreted
as conditional associations rather than causal effects.
...
tantrum are consistent with Vo and Tran (2020), who show that shocks
from the US equity market spill over to ASEAN markets, and with Chow
(2017), who links Asian-market exposure to financial openness. The
COVID-19 increase also accords with Sethapramote et al. (2023), who find
stronger global-to-ASEAN and intraregional spillovers during the
pandemic. The present estimates extend those studies by identifying how
a common external disturbance is redistributed *within* the ASEAN
network across several episodes: Indonesia and Thailand are the
principal full-sample transmitters, whereas Singapore is a net receiver
in the baseline model.

The results for Vietnam add a further qualification. Vo and Ellis (2018)
document Vietnam's increasing linkages with advanced markets, while Al
Anshari (2025) find relatively weak full-period correlations between
...
evidence of Hoque et al. (2026): the direction and strength of ASEAN
...
::: {#ref-AlAnshari2025 .csl-entry}
Al Anshari, M. F. (2025). Shocks, structure, and signals: Mapping the
evolution of ASEAN-6 stock market networks before, during, and after
COVID-19 using graph neural networks. *Asian Journal of Social and
Humanities*, *3* <https://doi.org/10.59888/ajosh.v3i12.613>.
:::

::: {#ref-BIS2015China .csl-entry}
Bank for International Settlements (2015). EME vulnerabilities take
centre stage. <https://www.bis.org/publ/qtrpdf/r_qt1509a.htm>.
:::

::: {#ref-Bernanke2013 .csl-entry}
Bernanke, B. S. (2013). The economic outlook: Testimony before the joint
economic committee, u.s. congress.
<https://www.federalreserve.gov/newsevents/testimony/bernanke20130522a.htm>.
:::

::: {#ref-FederalReserve2022 .csl-entry}
Board of Governors of the Federal Reserve System (2023a). Record of
policy actions of the board of governors.
<https://www.federalreserve.gov/publications/2022-ar-record-of-policy-actions-of-the-board-of-governors.htm>.
:::

::: {#ref-FederalReserve2023SVB .csl-entry}
Board of Governors of the Federal Reserve System (2023b). Review of the
federal reserve's supervision and regulation of silicon valley bank.
<https://www.federalreserve.gov/publications/files/svb-review-20230428.pdf>.
:::

::: {#ref-CaldaraIacoviello2022 .csl-entry}
Caldara, D., and Iacoviello, M. (2022). Measuring geopolitical risk.
*American Economic Review*, *112*
<https://doi.org/10.1257/aer.20191823>.
:::

::: {#ref-Chow2017 .csl-entry}
Chow, H. K. (2017). Volatility spillovers and linkages in Asian stock
markets. *Emerging Markets Finance and Trade*, *53*
<https://doi.org/10.1080/1540496X.2017.1314960>.
:::

::: {#ref-DieboldYilmaz2012 .csl-entry}
Diebold, F. X., and Yilmaz, K. (2012). Better to give than to receive:
Predictive directional measurement of volatility spillovers.
*International Journal of Forecasting*, *28*
<https://doi.org/10.1016/j.ijforecast.2011.02.006>.
:::

::: {#ref-DieboldYilmaz2014 .csl-entry}
...
::: {#ref-ECB2012FSR .csl-entry}
European Central Bank (2012). Financial stability review: June 2012.
<https://www.ecb.europa.eu/pub/pdf/fsr/financialstabilityreview201206en.pdf>.
:::

::: {#ref-ForbesRigobon2002 .csl-entry}
Forbes, K. J., and Rigobon, R. (2002). No contagion, only
interdependence: Measuring stock market comovements. *Journal of
Finance*, *57* <https://doi.org/10.1111/0022-1082.00494>.
:::

::: {#ref-HoqueEtAl2026 .csl-entry}
Hoque, M. E., Low, S.-W., Tee, L.-T., Uddin, Md. A., Kew, S.-R., Billah,
M., and Bilgili, F. (2026). Contemporaneous and lagged connectedness
among international categorical economic policy uncertainty and ASEAN-5
stock markets: Do policy uncertainty sources and determinants matter?
...
::: {#ref-NeweyWest1987 .csl-entry}
Newey, W. K., and West, K. D. (1987). A simple, positive semi-definite,
heteroskedasticity and autocorrelation consistent covariance matrix.
*Econometrica*, *55* <https://doi.org/10.2307/1913610>.
:::

::: {#ref-USTR2018 .csl-entry}
Office of the United States Trade Representative (2018). Section 301
product list fact sheet.
<https://ustr.gov/about-us/policy-offices/press-office/fact-sheets/2018/june/section-301-product-list-fact-sheet>.
:::

::: {#ref-Parkinson1980 .csl-entry}
Parkinson, M. (1980). The extreme value method for estimating the
variance of the rate of return. *Journal of Business*, *53*
<https://doi.org/10.1086/296071>.
:::

::: {#ref-PesaranShin1998 .csl-entry}
Pesaran, M. H., and Shin, Y. (1998). Generalized impulse response
analysis in linear multivariate models. *Economics Letters*, *58*
<https://doi.org/10.1016/S0165-1765(97)00214-0>.
:::

::: {#ref-SethapramoteEtAl2023 .csl-entry}
Sethapramote, Y., Prukumpai, S., and Dacuycuy, L. B. (2023). Dynamic
connectedness in the ASEAN's equity markets during the COVID-19
pandemic. *DLSU Business & Economics Review*, *32*
<https://doi.org/10.59588/2243-786X.1153>.
:::

::: {#ref-UNGA2022 .csl-entry}
United Nations General Assembly (2022). Aggression against Ukraine.
(A/RES/ES-11/1) <https://digitallibrary.un.org/record/3959039>.
:::

::: {#ref-VoEllis2018 .csl-entry}
Vo, X. V., and Ellis, C. (2018). International financial integration:
Stock return linkages and volatility transmission between Vietnam and
advanced countries. *Emerging Markets Review*, *36*
<https://doi.org/10.1016/j.ememar.2018.03.007>.
:::

::: {#ref-VoTran2020 .csl-entry}
Vo, X. V., and Tran, T. T. A. (2020). Modelling volatility spillovers
from the US equity market to ASEAN stock markets. *Pacific-Basin Finance
Journal*, *59* <https://doi.org/10.1016/j.pacfin.2019.101246>.
:::

::: {#ref-WHO2020 .csl-entry}
World Health Organization (2020). Statement on the second meeting of the
